...
This document outlines the mandatory coding standards, security policies, and AI usage guidelines for this project.

## 🤖 AI Configuration
All AI assistants (Claude, Gemini, GitHub Copilot, Cursor) are configured to follow these exact rules.
- **Reference**: `CLAUDE.md`, `.agent/rules/`, `.cursor/rules/`, `.github/copilot-instructions.md`
